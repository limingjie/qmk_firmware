...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
         ...
         KC_LSPO,   KC_NO,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,   KC_NO, KC_RSPC,   MO(1),
    ...
    [1] = LAYOUT_all(
        KC_POWER,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,  KC_DEL,
         _______, _______, SCR2DSK,  FINDER, _______, _______, _______, KC_PGUP, KC_PGDN, _______, KC_MPLY, KC_MRWD, KC_MFFD,            RESET,
         _______,   KC_F4, SCR2CLP,  KC_F11, FULLSCR, _______, KC_HOME,  KC_END, _______, LOCKSCR,  KC_F14,  KC_F15,   KC_NO,          KC_BTN1,
         _______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,   KC_NO, _______, _______,

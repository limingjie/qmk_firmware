...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_ansi_split_rshift(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_RGUI, RALT_T(KC_LEFT), RCTL_T(KC_DOWN), LT(1, KC_RGHT)),
    [1] = LAYOUT_60_ansi_split_rshift(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, LT(1, KC_END)),
    [2] = LAYOUT_60_ansi_split_rshift(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, LT(1, KC_RGHT))};
